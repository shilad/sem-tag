...
public interface Dao<T> {
    ...
    /**
     * Returns an SQL string that will save the item to the database.
     ...
     * @param filter a set of filters to limit the search
     ...
     */
    public Iterable<T> get(DaoFilter filter) throws DaoException;
